...
function StatsPreviewCard() {
  return (
    <div className='bg-[#1b1938] w-[340px] h-[820px] rounded-2xl'>
        ...
        <div className='p-4 mt-4 text-white'>
            <div>
                <p className='line-height text-[2em] text-center font-bold'>
                    Get <span className='  text-violet-500'>Insight</span> that help your bussiness grow.
                </p>
                <p className='leading-8 mt-6 opacity-60 text-center my-2 text-[20px]'>
            ...
            <div className='flex flex-col gap-4 justify-center items-center text-center'>
                ...
                <div>
                    <p className='font-bold text-[2rem]'>12M+</p>
